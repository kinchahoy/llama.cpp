...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/bench-results/gfx906-q4k-profile}"
REPORT="${REPORT:-$ROOT_DIR/gfx906-q4k-profile-diff.md}"
DEVICE="${DEVICE:-ROCm0}"
...
write_report() {
    "$ROOT_DIR/scripts/analyze-gfx906-q4k-profile.py" \
        --input "$OUTPUT_DIR" \
        --output "$REPORT"
    echo "Report: $REPORT"
}
